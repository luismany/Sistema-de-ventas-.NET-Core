...
$("#btnGuardar").click(function () {
    ...
    //primero se valida que los input no esten vacios
    ...
    //clonamos el modelo base y asignamos los valores de cada texbox al modelo
    ...
    if (modelo.idUsuario == 0) {
        ...
        fetch("/Usuario/Editar", {
            ...
            .then(responseJson => {
                if (responseJson.estado) {
                    //se modifica la fila seleccionada
